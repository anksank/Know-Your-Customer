sap.ui.controller("Client.productPage", {
...
*/
   onInit: function() {
	sap.ui.globalParameters.productPageControlCont = this;
   },
   loadTopBottomBrands: function(){
      var PassingParam = {};
      PassingParam.topBottom = true;
      var that = this;
       var handler={};
        handler.callback=function(data){
            that.getView().renderBrands(data);
        };
   ...
   brandPressHandler : function(event){
       ...
       var control = sap.ui.globalParameters.productPageControlCont;
       var str = [];
   ...
   bindOverlay : function(data){
       ...
       control.conversionSlider.attachChange(that.conversionHandler,that);
